...
public class Lesson44Server extends BasicServer {
    ...
    public Lesson44Server(String host, int port) throws IOException {
        ...
        registerGet("/journal/bookInfo",this::bookInfoHandler);
    }

    private void bookInfoHandler(HttpExchange exchange) {
        renderTemplate(exchange,"bookInfo.ftlh",getBookInfoDataModel());
    }

    private Object getBookInfoDataModel() {
        return new BookInfoDataModel();
    }

    private void journalHandler(HttpExchange exchange) {
        renderTemplate(exchange, "journal.ftlh", getJournalDataModel());
    }

    private Object getJournalDataModel() {
    ...
    private Object getEmployeeDataModel() {
